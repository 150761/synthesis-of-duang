        ...
        var a = e("./GameManager")
          ...
          , p = function(e) {
            ...
            t.prototype.adsButtonFunc2 = function() {
                if (adLink) {
                    var audioPlayer = document.getElementById("bg_audio")
        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.update = function(e) {
                ...
                this.node.y + this.node.width / 2 > cc.find("Canvas/lineNode").children[0].y && 0 == this.pengzhuangCount && this.endCtrl && 0 == this.endOne && this.testEndDJS > 3 && wuDi) {
                    // 无敌模式
                    a.default.GameUpdateCtrl = !1,
                    a.default.playerTouch = !1;
            ...
            t.prototype.onBeginContact = function(e, t, n) {
                ...
                "fruit" == n.node.group) {
                    ...
                    cc.tween(t.node).to(.1, {
                        ...
                        n.node.destroy(),
                        t.node.destroy()
                    }).start())) : c == r && border == c && border == r && // 边界逻辑
